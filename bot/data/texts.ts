...
export const startServiceMessageText =
    ...
    "Чтобы внести данные, используйте команду /report\n\n" +
    "Также вам доступен сервис аналитики!\n\n" +
    "На данный момент доступно два варианта запроса аналитики:\n\n" +
    "/analytics headache 7\n" +
    "/analytics mental 7\n\n" +
    "Где 7 это число дней на которые идет запрос по аналитике.\n\n" +
    "\u2022 headache - ключ для графика по головной боли\n" +
    "\u2022 mental  - ключ для графика по ментальному состоянию";
